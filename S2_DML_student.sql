...
INSERT INTO uitvoeringen(cursus,begindatum,docent,locatie) VALUES('S02','2026-03-02', 7369,'LEERDAM');
...
-- voer zijn of haar gegevens in. Kies een personeelnummer boven de 8000.
     INSERT INTO medewerkers(mnr,naam,voorl,functie,gbdatum,maandsal) VALUES(8001,'BOS','D','STAGAIR','2004-06-15',0);                                                                                   -- [TEST]
-- de test faalt maar hij lijkt er wel in te zitten
...
-- tussen de 3001 en 4000 euro verdienen. Zij krijgen een toelage van 500 euro.
                                                                                       -- [TEST]
insert into schalen(snr,ondergrens,bovengrens,toelage) values(7,3001,4000,500);
-- ook hier is de test niet gelukt maar de query wel
...
-- mensen in.  
-- [TEST]
insert into cursussen(code,omschrijving,type,lengte) values('D&P','bezemvak','ALG',6);
INSERT INTO uitvoeringen(cursus,begindatum,docent,locatie) VALUES('D&P','2026-03-02', 7369,'LEERDAM');
INSERT INTO uitvoeringen(cursus,begindatum,docent,locatie) VALUES('D&P','2026-05-02', 7369,'LEERDAM');
insert into inschrijvingen(cursist,cursus,begindatum) values(7876,'D&P','2026-03-02');
insert into inschrijvingen(cursist,cursus,begindatum) values(7900,'D&P','2026-03-02');
insert into inschrijvingen(cursist,cursus,begindatum) values(7902,'D&P','2026-03-02');
...
-- hij is ingeschreven voor een cursus
...
INSERT INTO medewerkers(mnr,naam,voorl,gbdatum,maandsal,afd,chef)
VALUES(8012,'BHIKHOE','P','2001-12-12',6000,50,7839);
update afdelingen
SET hoofd = 8012
where anr = 50;
