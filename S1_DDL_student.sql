...
-- VALUES(8000,'DONK','A','1965-01-11',6000,50,7839);
-- update afdelingen
...
-- ALTER COLUMN anr SET DEFAULT nextval('afd_anr');

-- ALTER TABLE afdelingen
-- ALTER COLUMN anr TYPE NUMERIC(3);
-- INSERT INTO afdelingen (naam, locatie) VALUES ('FINANCIËN', 'ZEIST');
-- INSERT INTO afdelingen (naam, locatie) VALUES ('PERSONEEL', 'MAARN');
-- INSERT INTO afdelingen (naam, locatie) VALUES ('ICT', 'WOUDENBERG');
-- INSERT INTO afdelingen (naam, locatie) VALUES ('MARKETING', 'LOPIK');
-- INSERT INTO afdelingen (naam, locatie) VALUES ('INKOOP', 'LANGBROEK');
-- INSERT INTO afdelingen (naam, locatie) VALUES ('LOGISTIEK', 'DOORN');
...
--     ingangsdatum    DATE,
--     einddatum  		DATE          CONSTRAINT a_datum_chk 		 CHECK (einddatum>ingangsdatum) ,
...
-- );
-- INSERT INTO adressen(postcode,huisnummer,ingangsdatum,einddatum,telefoon,med_mnr) VALUES('3435JH',8,'10-02-2015', '10-06-2018',0612345678,8000);
